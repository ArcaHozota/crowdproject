...
function buildTableBody(result) {
	...
	$.each(index, (index, item) => {
		let idTd = $("<th scope='row' class='text-center table-info' style='width:150px;vertical-align:middle;'></th>").append(item.id);
		let nameTd = $("<td scope='row' class='text-center table-info' style='width:100px;vertical-align:middle;'></td>").append(item.name);
		...
		let btnTd = $("<td class='text-center table-info' style='width:100px;vertical-align:middle;'></td>").append(fuyoBtn).append(" ").append(editBtn).append(" ").append(deleteBtn);
