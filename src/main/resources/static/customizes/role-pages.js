...
function buildTableBody(result) {
	...
	$.each(index, (index, item) => {
		...
		let nameTd = $("<td scope='row' class='text-center table-warning' style='width:100px;vertical-align:middle;'></td>").append(item.name);
		...
		let btnTd = $("<td class='text-center table-warning' style='width:100px;vertical-align:middle;'></td>").append(fuyoBtn).append(" ").append(editBtn).append(" ").append(deleteBtn);
