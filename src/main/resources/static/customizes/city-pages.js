...
function buildTableBody(result) {
	...
	$.each(index, (index, item) => {
		...
		let flagImg = $("<img>").attr('src', '../static/image/flags/' + item.cityFlag + '.png').attr('alt','flag');
		let flagTd = $("<td scope='row' class='text-center' style='width:50px;vertical-align:middle;'></td>").append(flagImg);
